...
The plot below visualizes the most popular cards in MTG tournament play, looking specifically at legacy events
(events in which decks can consist of most cards ever printed).
...
The chart shows the most popular cards at a specified point in time,
...
:::{.column-page}
<h2 id="time">
Legacy metagame breakdown by prevalence:
</h2>
:::
