...
<div class='content'>
  ...
  <!-- Data Visualization (tall)-->
  <section id="hide-short">
  <!-- <div class="container" style="width:250px;margin-left:15%;"> -->

  <!-- <div class='hex'>	 -->
  <!-- [![](hex-logos/ggdensity.svg){fig-alt="ggdensity"}](https://google.com) -->
  <!-- </div> -->

  <!-- <div class='hex hex-gap'>	 -->
  <!-- [![](hex-logos/TDAvis.svg){fig-alt="TDAvis"}](https://google.com) -->
  <!-- </div>	 -->

  <!-- <div class='hex'>	 -->
  <!-- [![](hex-logos/ggspatreg.svg){fig-alt="ggspatreg"}](https://google.com) -->
  <!-- </div> -->
  ...
  <!-- <div id="hide-small" style = "margin-top:2%;margin-left:13%;margin-right:5%"> -->
  ...
  <section id="hide-tall"  style="scroll-snap-align: none;height:200px;">
  ...
  <!-- Documentation (short) -->
  <section id="hide-tall"  style="scroll-snap-align: none;height:180px;">
  ...
  <h2> Miscellaneous </h2>
  - [**goodreadR**](https://github.com/jamesotto852/goodreadR): Scrape user data from [goodreads.com](https://goodreads.com/){.link-dim}
